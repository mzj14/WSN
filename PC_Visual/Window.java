...
class Window {
    ...
    public static final int[] yMinValue = {6600, 600, 800};
    public static final int[] yMaxValue = {6900, 900, 1100};
    ...
    /* my work */
    JComboBox makeComboBox(String[] list, ActionListener action) {
    ...
    /* my work */
    setVisualMode(Window.TEMPERATURE);
